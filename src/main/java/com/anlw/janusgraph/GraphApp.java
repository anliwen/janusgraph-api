...
public class GraphApp {
	...
	/**
	 * Opens the graph instance. If the graph instance does not exist, a new graph
	...
	/**
	 * Makes an update to the existing graph structure. Does not create any new
	 * vertices or edges.
	 */
	...
	/**
	 * Deletes elements from the graph structure. When a vertex is deleted, its
	 * incident edges are also deleted.
	 */
	...
	/**
	 * Run the entire application: 1. Open and initialize the graph 2. Define the
	 * schema 3. Build the graph 4. Run traversal queries to get data from the graph
	 * 5. Make updates to the graph 6. Close the graph
	 */
	public void runApp() {
		try {
